...
namespace Rally.Lib.Persistence.Oracle.Standard
{
    public class OracleDBOperatorStandard : IDMLOperable
    {
        public static IDMLOperable NewInstance(string ConnectionString)
        {
            return new OracleDBOperatorStandard(ConnectionString);
        }
        ...
        public OracleDBOperatorStandard(string ConnectionString)
        {
