...
namespace Rally.Lib.Persistence.SQLite.Standard
{
    public class SQLiteDBOperatorStandard : IDMLOperable
    {
        /// <summary>
        /// 数据库连接
        /// </summary>
        ...
        {
            return new SQLiteDBOperatorStandard(ConnectionString);
        }

        public SQLiteDBOperatorStandard(string strConnection)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
