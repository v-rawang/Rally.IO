...
namespace Rally.Lib.Signal.Core.Parameter
{
    public class SerialPortParameter : ParameterBase
    {
        ...
        private bool shouldDiscardOutBuffer = true;
        private bool shouldDiscardInBuffer = true;
        ...
        [DefaultValue(true)]
        public bool ShouldDiscardOutBuffer { get { return this.shouldDiscardOutBuffer; } set { this.shouldDiscardOutBuffer = value; } }

        [DefaultValue(true)]
        public bool ShouldDiscardInBuffer { get { return this.shouldDiscardInBuffer; } set { this.shouldDiscardInBuffer = value; } }
