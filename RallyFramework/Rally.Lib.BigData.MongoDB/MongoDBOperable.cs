...
namespace Rally.Lib.BigData.MongoDB
{
    public class MongoDBOperable
    {
        public static MongoDBOperable NewInstance(string ConnectionString, string DatabaseName, string CollectionName) 
        {
            return new MongoDBOperable(ConnectionString, DatabaseName,  CollectionName);
        }
        ...
        public MongoDBOperable(string ConnectionString, string DatabaseName, string CollectionName)
        {
