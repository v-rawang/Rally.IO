...
using Rally.Framework.View;

namespace Views.BackstageView
{
    /// <summary>
    ...
    /// </remarks>
    public partial class BackstageView : UserControl, IContainerControl, IView
    {
        ...
        [Browsable(true)]
        public event Func<object, object> OnMenuItemClicked; 
        ...
        //public object Banner { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            if (this.OnMenuItemClicked != null)
            {
                this.OnMenuItemClicked(associatedPage);
            }
        }
        ...
        public void SetModel(object ViewModel)
        {
            throw new NotImplementedException();
        }

        public void SetLayout(object ViewLayout)
        {
            throw new NotImplementedException();
        }
    }
