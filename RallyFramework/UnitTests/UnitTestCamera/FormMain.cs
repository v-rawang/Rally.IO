...
using Newford.Lib.Camera.Core.Parameter;
using Newford.Lib.Camera.HC;
using Newford.Lib.Camera.CT;
...
namespace AcquisitionConsole
{
    public partial class FormMain : Form
    {
        ...
        {
            this.propertyGridParameters.SelectedObject = null;//this.parameters[this.comboBoxParameters.SelectedIndex];
        }
        ...
        private void testToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Action action = new Action(() => 
            {
                ...
                {
                    this.pictureBoxAcquiredImage.Image = this.bitmap;
                    this.listBoxBarcodes.DataSource = null; //pair.Items[1].GetParameterValue("BarCodes").Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries); //barcodes;
