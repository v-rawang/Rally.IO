...
namespace Rally.Framework.Logging
{
    public class LogItem
    {
        ...
        public override string ToString()
        {
            ...
            return "Title=" + this.Title + this.separator + "Message=" + this.Message + this.separator + "Categroy=" + this.Category + this.separator + "Level=" + this.Level + this.separator + "TimeStamp=" + this.TimeStamp.ToString() + this.separator + "MachineName=" + this.MachineName + this.separator + "User=" + this.UserName;
