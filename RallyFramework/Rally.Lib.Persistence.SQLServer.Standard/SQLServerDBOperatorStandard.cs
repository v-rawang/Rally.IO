...
namespace Rally.Lib.Persistence.SQLServer.Standard
{
    public class SQLServerDBOperatorStandard : IDMLOperable
    {
        /// <summary>
        /// 数据库连接
        /// </summary>
        ...
        {
            return new SQLServerDBOperatorStandard(ConnectionString);
        }

        public SQLServerDBOperatorStandard(string strConnection)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
