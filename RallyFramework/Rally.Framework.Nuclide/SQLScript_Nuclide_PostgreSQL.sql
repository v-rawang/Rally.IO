...
CREATE TABLE nuclide  (
  ...
  Energy1 real NULL DEFAULT NULL,
  BranchingRatio1 real NULL DEFAULT NULL,
  Channel1 real NULL DEFAULT NULL,
  Energy2 real NULL DEFAULT NULL,
  BranchingRatio2 real NULL DEFAULT NULL,
  Channel2 real NULL DEFAULT NULL,
  Energy3 real NULL DEFAULT NULL,
  BranchingRatio3 real NULL DEFAULT NULL,
  Channel3 real NULL DEFAULT NULL,
  HalfLife real NULL DEFAULT NULL,
